...
function sleep(ms) {
    clearInterval( sleep_set_timeout_ctrl );
    return new Promise( resolve => sleep_set_timeout_ctrl = setTimeout( resolve, ms ));
}
